# jira-resource-api Specification

## Purpose

Define the bounded project-scoped Jira resource API, its security boundaries and the responsibilities retained by callers.
